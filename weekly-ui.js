...
function installWeeklySubjectUi() {
  ...
  dialog.innerHTML = `
    ...
    <div class="weekly-recognition-workspace">
      ...
      <div id="weeklyRecognitionCandidates" class="weekly-recognition-candidates" aria-label="読み取り候補"><p class="weekly-candidate-empty">読み取り候補はまだありません。</p></div>
